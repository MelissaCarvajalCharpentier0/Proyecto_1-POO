 ...
 */
import modelo.Areas.Area;
import modelo.Areas.NivelPiso;
import modelo.Elementos.Elemento;
import modelo.Usuarios.Administrador;
import modelo.Usuarios.EmpleadoExterno;
import modelo.Usuarios.EmpleadoInterno;
import modelo.Usuarios.SuperUsuario;
import modelo.Usuarios.Usuario;

/**
 *
 * @author Esteban Solnano, Melissa Carvajal, Jocelyn Gomez
 */
